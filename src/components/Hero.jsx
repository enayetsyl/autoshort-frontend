...
const Hero = () => {
  return (
    <div className='max-w-6xl mx-auto px-5 pt-24 pb-14 gap-5'>
      {/* left div */}
        <div className='flex flex-col justify-center items-center '>
          <h1 className="bg-gradient-to-r from-primary to-blue-700 text-transparent text-5xl lg:text-7xl text-center lg:text-left font-bold leading-snug" style={{ backgroundClip: 'text' }}>Faceless Videos on Auto-Pilot.</h1>
